...
describe("klaviyoUtils.js script", function () {
  var klaviyoUtilsFile = proxyquire(
  ...
  describe("trackEvent function", function () {
    it("should return a 1 if track call succeeds", function () {
      var trackCallResult = klaviyoUtilsFile.trackEvent(
        payloadObj.customer_properties.$email,
        {},
        "Event Name"
      );
  ...
  describe("prepareViewedProductEventData function", function () {
    it("should return viewed product event data with appropriate keys", function () {
      ...
      var viewedProductObj = klaviyoUtilsFile.prepareViewedProductEventData(
        1,
